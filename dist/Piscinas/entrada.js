(function () {
  ...
  function renderNotFound() {
    ...
    if (bodyEl) {
      bodyEl.innerHTML = [
        ...
        '<p>Vuelve a la portada para ver las últimas publicaciones y noticias.</p>'
      ].join("");
    }
  }
  ...
  async function main() {
    ...
    try {
      ...
      const list = normalizedType === "news" ? (Array.isArray(feed.news) ? feed.news : []) : (Array.isArray(feed.posts) ? feed.posts : []);
